...
class _EditPackageScreenState extends State<EditPackageScreen> {
  ...
  void initState() {
    ...
    _availableSeatsController = TextEditingController(text: p.availableSeats.toString());
    _provinceController = TextEditingController(text: p.province ?? '');
    _departureCityController = TextEditingController(text: p.departureCity ?? '');
    _notIncludedController = TextEditingController(text: p.notIncluded ?? '');
    _tripHighlightsController = TextEditingController(text: p.tripHighlights ?? '');
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Text('Edit Package', style: AppTextStyles.headingMedium),
                    ],
                  ),
                ),
                Expanded(
                          ...
                          child: Column(
                            ...
                            children: [
                                        ...
                                        : widget.package.image != null
                                            ...
                                            : const Center(
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Icon(Icons.cloud_upload_outlined, size: 50, color: AppColors.textTertiary),
                                                    SizedBox(height: 12),
                                                    Text('Click to change image', style: AppTextStyles.bodyMedium),
                                                    SizedBox(height: 4),
                                                    Text('PNG, JPG up to 5MB', style: AppTextStyles.bodySmall),
                                                  ],
                                                ),
                                              ),
                                  ),
                              ...
                              _buildSection(
                                ...
                                Column(
                                  children: [
                                    _buildCheckbox('Transport', _includeTransport,
                                        (v) => setState(() => _includeTransport = v!)),
                                    _buildCheckbox('Accommodation', _includeAccommodation,
                                        (v) => setState(() => _includeAccommodation = v!)),
                                    _buildCheckbox('Meals', _includeMeals,
                              ...
                              _buildSection(
                                ...
                                CustomInput(
                                  ...
                                  hint: 'e.g., Scenic mountain views, Bonfire night',
                                  maxLines: 4,
                                ),
                              ),
                              const SizedBox(height: 32),
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            CustomInput(
                                              ...
                                              hint: 'e.g., Arrival & Sightseeing',
                                            ),
                                            const SizedBox(height: 12),
                                            CustomInput(
                                              label: 'Activities & Details',
                                              controller: day['description']!,
                                              hint: 'Describe activities for this day...',
                                              maxLines: 4,
                                            ),
                                          ],
                                        ),
                              ...
                              _buildSection(
                                ...
                                Column(
                                  children: [
                                    _buildCheckbox('Mark as Featured', _isFeatured,
                                        (v) => setState(() => _isFeatured = v!)),
                                    _buildCheckbox('Has Discount', _hasDiscount,
                                            ...
                                            Container(
                                              ...
                                              child: const Row(
                                                ...
                                                children: [
                                                  ...
                                                  SizedBox(width: 4),
                                                  Text('Featured', style: TextStyle(color: Colors.white, fontSize: 12)),
                                                ],
                                              ),
                                            ),
                                          if (_isFeatured && _hasDiscount) const SizedBox(width: 8),
                                          if (_hasDiscount)
                                            Container(
                                              padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                                              decoration: BoxDecoration(
