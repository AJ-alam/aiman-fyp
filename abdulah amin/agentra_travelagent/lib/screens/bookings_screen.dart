...
class _BookingsScreenState extends State<BookingsScreen>
  ...
  int get _totalConfirmed => _allBookingsRaw
  ...
  double get _totalRevenue => _allBookingsRaw
      .where((b) => b['status'] == 'confirmed' || b['status'] == 'completed')
      .fold(0.0, (sum, b) => sum + (b['totalAmount'] ?? 0).toDouble());

  Future<void> _cancelBooking(String bookingId, String packageTitle) async {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final confirmedCount =
            bookings.where((b) => b['status'] == 'confirmed' || b['status'] == 'completed').length;
            ...
            children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: (package['image'] != null && package['image'].isNotEmpty)
                            ? DecorationImage(image: NetworkImage(package['image']), fit: BoxFit.cover)
                            : null,
                        ),
                        child: (package['image'] == null || package['image'].isEmpty)
                          ? const Icon(Icons.landscape_outlined, color: AppColors.primary, size: 32)
                          : null,
                      ),
              ...
              if (isExpanded) ...[
                ...
                ...bookings.map((booking) =>
                    _buildBookingRow(booking, package['title'])),
              ],
            ],
          ),
        );
  ...
  Widget _buildBookingRow(dynamic booking, String packageTitle) {
    final bool isConfirmed = booking['status'] == 'confirmed' || booking['status'] == 'completed';
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                _buildDetailRow(Icons.event_seat_outlined, 'Seats: ${booking['seats']}'),
                _buildDetailRow(Icons.payments_outlined, 'Total Paid: PKR ${booking['totalAmount']}'),
          ...
          if (isConfirmed)
            TextButton(
              onPressed: () => _cancelBooking(booking['_id'], packageTitle),
