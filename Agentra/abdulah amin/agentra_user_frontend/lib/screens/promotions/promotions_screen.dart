...
class _PromotionsScreenState extends State<PromotionsScreen> {
  ...
  title: const Text(
    '🌍 Top Travel Deals',
    style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black), // ← change to black so it's visible
  ),
  iconTheme: const IconThemeData(color: Colors.black), // ← change to black too
),
      body: loading
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                _chip('🍽️ ${pkg['meals'] ?? 'N/A'}'),
                _chip('🚗 ${pkg['transport'] ?? 'N/A'}'),
                _chip('🏨 ${pkg['accommodation'] ?? 'N/A'}'),
                _chip('💺 ${pkg['availableSeats'] ?? 'N/A'} seats left'),
              ],
            ),
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => PackageDetailScreen(packageId: pkg['_id'] ?? ''),
    ),
  );
},
